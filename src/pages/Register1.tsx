...
const Register: React.FC = () => {
  ...
  const onSubmit = async (data: SignUpFormData) => {
    ...
    // eslint-disable-next-line @typescript-eslint/no-explicit-any
      ...
      // Dismiss loading toast and show appropriate error
      toast.dismiss(loadingToast);
  ...
  return (
    <div className="min-h-screen bg-base-200 flex items-center justify-center p-6">
      <div className="w-full max-w-4xl grid grid-cols-1 md:grid-cols-2 bg-white shadow-xl rounded-xl overflow-hidden">
        ...
        <div className="p-10">
          <h2 className="text-3xl font-bold mb-6 text-neutral">Create an Account</h2>
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
            <div className="form-control">
                        ...
                        <div className="form-control">
                          <label className="label">
                            <span className="label-text text-base-content font-medium">Contact Phone</span>
                          </label>
                          <div className="relative">
                          ...
                          {errors.contactPhone && <p className="text-error text-sm mt-1">{errors.contactPhone.message}</p>}
                        </div>
                        ...
                        <div className="form-control">
                          <label className="label">
                            <span className="label-text text-base-content font-medium">User Type</span>
                          </label>
                          <div className="relative">
                          ...
                          {errors.userType && <p className="text-error text-sm mt-1">{errors.userType.message}</p>}
                        </div>
                        ...
                        <div className="form-control">
                          ...
                          {errors.agreeToTerms && <p className="text-error text-sm mt-1">{errors.agreeToTerms.message}</p>}
                        </div>
            
                        <button type="submit" disabled={isSubmitting} className="btn btn-primary w-full text-white">
          ...
          <div className="grid grid-cols-3 gap-3">
            <button type="button" className="btn btn-outline w-full"><Facebook className="h-5 w-5 text-blue-600" /></button>
            <button type="button" className="btn btn-outline w-full"><Twitter className="h-5 w-5 text-blue-400" /></button>
            <button type="button" className="btn btn-outline w-full"><Github className="h-5 w-5 text-gray-800" /></button>
          </div>
